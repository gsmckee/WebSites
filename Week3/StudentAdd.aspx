...
<body>
    ...
    <div>
        ...
        <asp:TextBox runat="server" ID="tbF_name" />    <asp:RegularExpressionValidator runat="server" ControlToValidate="tbF_name" 
        ...
        <asp:TextBox runat="server" ID="tbL_name" />   <asp:RegularExpressionValidator runat="server" ControlToValidate="tbL_name" 
            ErrorMessage="The name can only contain letters!" 
            ValidationExpression="^[a-zA-Z''-'\s]{1,40}$" />    <br />
